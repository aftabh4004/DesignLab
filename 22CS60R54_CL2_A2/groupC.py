...
def p_start(p):
    '''start : root BEGINGROUPD skipall'''
...
def p_root(p):
    '''root : BEGINGROUPA skipall BEGINGROUPC skiptag OPENTABLE handlegoalrow CLOSETABLE handledatetime OPENTABLE handlerow CLOSETABLE handleinfo skiptag root
