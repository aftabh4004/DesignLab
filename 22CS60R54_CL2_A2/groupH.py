...
def p_start(p):
    '''start : root BEGINKNOCKOUT skipall'''
...
def p_root(p):
    '''root : BEGINGROUPA skipall BEGINGROUPH skiptag OPENTABLE handlegoalrow CLOSETABLE handledatetime OPENTABLE handlerow CLOSETABLE handleinfo skiptag root
