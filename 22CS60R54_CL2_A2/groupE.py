...
def p_start(p):
    '''start : root BEGINGROUPF skipall'''
...
def p_root(p):
    '''root : BEGINGROUPA skipall BEGINGROUPE skiptag OPENTABLE handlegoalrow CLOSETABLE handledatetime OPENTABLE handlerow CLOSETABLE handleinfo skiptag root
