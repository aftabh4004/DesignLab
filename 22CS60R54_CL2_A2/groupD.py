...
def p_start(p):
    '''start : root BEGINGROUPE skipall'''
...
def p_root(p):
    '''root : BEGINGROUPA skipall BEGINGROUPD skiptag OPENTABLE handlegoalrow CLOSETABLE handledatetime OPENTABLE handlerow CLOSETABLE handleinfo skiptag root
