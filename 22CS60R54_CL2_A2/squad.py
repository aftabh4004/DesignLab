...
# def p_start(p):
#     '''start : root BEGINGROUPB skipall'''
...
#     '''handlegoalData : OPENDATA CONTENT CLOSEDATA OPENHEADER OPENHREF CONTENT CLOSEHREF skipcontent CLOSEHEADER OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA OPENDATA skiptag CLOSEDATA
#                       | OPENDATA CONTENT CLOSEDATA OPENHEADER OPENHREF CONTENT CLOSEHREF skipcontent CLOSEHEADER OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA OPENDATA CONTENT CLOSEDATA'''
#     # print('===========================================================================')
#     # print()
#     # print('Goal forwarded & conceded')
#     # print(p[6] + ' ' + p[23] + ' ' + p[26])
#     goalf_c.append([p[6], p[23], p[26]])
...
# def p_root(p):
#     '''root : BEGINGROUPA skiptag OPENTABLE handlegoalrow CLOSETABLE handledatetime OPENTABLE handlerow CLOSETABLE handleinfo skiptag root
