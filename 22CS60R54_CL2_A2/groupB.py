...
def p_start(p):
    '''start : root BEGINGROUPC skipall'''

def p_skipall(p):
    '''skipall : BEGINGROUPC skipall
               | BEGINGROUPD skipall         
               | BEGINGROUPE skipall         
               |    BEGINGROUPF skipall         
               |    BEGINGROUPG  skipall        
...
def p_root(p):
    '''root : BEGINGROUPA skipall BEGINGROUPB skiptag OPENTABLE handlegoalrow CLOSETABLE handledatetime OPENTABLE handlerow CLOSETABLE handleinfo skiptag root
