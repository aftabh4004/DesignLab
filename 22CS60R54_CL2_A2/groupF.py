...
def p_start(p):
    '''start : root BEGINGROUPG skipall'''
...
def p_root(p):
    '''root : BEGINGROUPA skipall BEGINGROUPF skiptag OPENTABLE handlegoalrow CLOSETABLE handledatetime OPENTABLE handlerow CLOSETABLE handleinfo skiptag root
